    ...
    <div className="phone-number-input-page">
      ...
      <main>
        ...
        <form>
          ...
          <button style={ !isPhoneNumberValid ? { backgroundColor: "#97a397", color: "#647c64" } : { backgroundColor: "#00c600" }} disabled={!isPhoneNumberValid} className="next-button">Berikutnya</button>
        </form>
      </main>
    </div>
  );
